...
-- Author: Snapopotamus
-- © 2024
-- A tree logging system for RedM servers. Based off of a mixture of RSG Mining and VORP Lumber. All due credits to the creators and contributors of those projects.
...
Config.CuttingLocations = {
  {
    coords = vector3(2510.64, -134.39, 45.63),
    showmarker = true,
    timeout = 120000,
    items = {
  ...
  {
    coords = vector3(2501.26, -121.62, 46.44),
    showmarker = true,
    timeout = 120000,
    items = {
  ...
  {
    coords = vector3(2497.48, -101.34, 47.13),
    showmarker = true,
    timeout = 120000,
    items = {
      { name = "sap",    label = "Sap",       chance = 8,  amount = 2 },
